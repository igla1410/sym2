 ...
 */
public class ImagingFederate
{
    public static final String READY_TO_RUN = "ReadyToRun";
    public static RTIambassador rtiamb;
    private ImagingFederateAmbassador fedamb;
    ...
    private boolean prepareFederate(String federateName) throws Exception {
        ...
        log("Connecting...");
        fedamb = new ImagingFederateAmbassador(this);
    ...
    public static void main(String[] args) {
        ...
        String federateName = "ImagingFederate";
        if (args.length != 0) {
            federateName = args[0];
        }

        try {
            new ImagingFederate().runFederate(federateName);
    ...
    private void log(String message) {
        System.out.println("czas: " + getTimeAsShort() + " - ImagingFederate   : " + message);
    }
